...
public class DBBiteDiseaseTest {
	...
	public void testInsertBiteDisease() 
	{
		...
		BiteDisease bitedisObj = new BiteDisease(2000,"Bidesår3");
	...
	{	
		DBBiteDisease dbbitedis = new DBBiteDisease();
		BiteDisease bitedisObj = new BiteDisease(5000, "Bidesår2");
		if(bitedisObj != null)
		{
		...
		dbbitedis.insertBiteDisease(bitedisObj);
		BiteDisease bite1 = dbbitedis.searchBiteDiseaseById(5000, false);
		...
		dbbitedis.deleteBiteDiseaseWithId(5000);
